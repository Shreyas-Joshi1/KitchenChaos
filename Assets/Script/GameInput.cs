...
public class GameInput : MonoBehaviour
{
    ...
    //    {
    //        foreach (var map in playerInputActions.asset.actionMaps)
    //        {
    //            map.RemoveAllBindingOverrides();
    //        }

    //        // Remove stored overrides from PlayerPrefs
    //        PlayerPrefs.DeleteKey(PLAYER_PREFS_BINDINGS);
    //        PlayerPrefs.Save();

    //        Debug.Log("All binding overrides have been cleared.");
    //    }
    //    else
    //    {
